...
<% 
			String fl= request.getParameter("foodlands");
			if (Objects.nonNull(fl)) {
						%>
		<h3 align="center">FOODLANDS</h3>				
		<table class="table table-striped">
					...
					<tbody>
						...
						List<HashMap<Object, Object>> fmenu = new ObjectMapper().readValue(fl, List.class);
								
												for (HashMap<Object, Object> eachMap : fmenu) {
