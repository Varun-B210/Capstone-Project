...
<% 
			String cr= request.getParameter("coriander");
			if (Objects.nonNull(cr)) {
						%>
		<h3 align="center">HOTEL CORIANDER</h3>				
		<table class="table table-striped">
					...
					<tbody>
						...
						List<HashMap<Object, Object>> cmenu = new ObjectMapper().readValue(cr, List.class);
								
												for (HashMap<Object, Object> eachMap : cmenu) {
